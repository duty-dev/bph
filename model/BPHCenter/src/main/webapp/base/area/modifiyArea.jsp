					...
					<div class="pane-content">
						...
						<div class="demo-section k-header">
							<form id="employeeForm" data-role="validator" novalidate="novalidate">
								<h4>巡区修改</h4>
								<ul>
										<li><input id="token" type="hidden" value="${requestScope.sessionId}"/>
										<input id="areaId" type="hidden" value="${area.id}"/></li>
										<li><span class="ty-input-warn" style="width:10px;margin-left:-10px;">*</span><label for="name">所属机构:</label>${area.organName}</li>
									<li><span class="ty-input-warn" style="width:10px;margin-left:-10px;">*</span><label for="name">巡区名称:</label> 
										<input type="text" class="k-textbox" name="name" id="name" value="${area.areaName}"/></li>
									...
									<li><label for="telephone">联系电话:</label> 
										<input type="text" class="k-textbox" name="tel" id="tel" value="${area.tel}"/></li>
									<li><label for="equipment">巡区人数:</label> 
										<input type="text" class="k-textbox" name="nnt" id="nnt"  value="${area.nnt}"/></li>
									<li class="actions">
										<button type="button" class="ty-button ty-button-te" onclick='updateAreaInfo()'>修改</button>
									</li>
								</ul>
							</form>
						</div>
...
<script type="text/javascript">
	...
	function updateAreaInfo(){
		...
		$.ajax({
			url:"<%=basePath%>area/updateAreabasic.do",
			type:"post",
			dataType:"json",
			data:{
				areaId:$("#areaId").val(),
