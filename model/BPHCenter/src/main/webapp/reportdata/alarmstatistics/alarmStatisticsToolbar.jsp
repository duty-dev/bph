...
<div id="template">
	...
	<div class="fl ml30 set-hei48">
		...
		<a id="btnalarmType" onclick="onChangeReportAction(1);"><span class="fl ty-btn-jqfl cursor"></span></a>
        <a id="btnalarmOrgan" onclick="onChangeReportAction(2);"><span class="fl ty-btn-jg cursor ml10"></span></a>   
        <a id="btnalarmCircle" href="<%=basePath %>reportRouteWeb/gotoAlarmStatistics.do?pageType=3" ><span class="fl ty-btn-zq cursor ml10"></span></a> 
        <a id="btnalarmTimeSpan" href="<%=basePath %>reportRouteWeb/gotoAlarmStatistics.do?pageType=4"><span class="fl ty-btn-sjd cursor ml10"></span></a>
		<div id="div_orgPath" class="ty-tj-title2"></div>
	</div>			
	<div class="fr set-hei48"><div class="ty-screen-mode" id="tyScreenMode">
