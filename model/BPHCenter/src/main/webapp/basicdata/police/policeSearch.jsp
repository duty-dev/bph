...
<div class="fl set-hei48">
	...
	<div class="fl set-hei48">
		<button id="undo" class="ty-btn-add ty-btn-offset" onclick="PoliceManage.addPolice()"></button>
                   <button id="btnImportPolice" class="ty-btn-dr ty-btn-offset"  onclick="PoliceManage.importPolice()">导入</button>
                   <button id="btnOutPortPolice" class="ty-btn-dc ty-btn-offset"  onclick="PoliceManage.outPortPolice()">导出</button>
	</div>
