...
<div id="template">
 	<div class="span5 txt-right">
 		<button id="btncreateGroup" class="ty-btn-cjfz ty-btn-offset2"  onclick="VehicleGroupManage.createGroup()">创建分组</button>
	    <button id="btneditGroup" class="ty-btn-xgfz ty-btn-offset2"  onclick="VehicleGroupManage.editGroup()">修改分组</button> 
	    <button id="btndeleteGroup" class="ty-btn-scfz ty-btn-offset2"  onclick="VehicleGroupManage.deleteGroup()">删除分组</button>
		<button id="btnaddMember" class="ty-btn-tjcy ty-btn-offset2"  onclick="VehicleGroupManage.addMember()">添加车辆</button>
 	</div>
 	<div class="span5">
 		<button id="btndeleteMember" class="ty-btn-sccy ty-btn-offset2" style="margin-left:40px;" onclick="VehicleGroupManage.deleteMember()">删除车辆</button> 
	    <button id="btnclearUpMember" class="ty-btn-qkcy ty-btn-offset2"  onclick="VehicleGroupManage.clearUpMember()">清空车辆</button>
 	</div>
