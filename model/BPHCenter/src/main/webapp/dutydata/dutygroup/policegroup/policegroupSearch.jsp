...
<div id="template">
	<div class="span5 txt-right">
	 	<button id="btncreateGroup" class="ty-btn-cjfz ty-btn-offset2"  onclick="PolicegroupManage.createGroup()">创建分组</button>
	    <button id="btneditGroup" class="ty-btn-xgfz ty-btn-offset2"  onclick="PolicegroupManage.editGroup()">修改分组</button>
	    <button id="btndeleteGroup" class="ty-btn-scfz ty-btn-offset2"  onclick="PolicegroupManage.deleteGroup()">删除分组</button> 
	    <button id="btnaddMember" class="ty-btn-tjcy ty-btn-offset2"  onclick="PolicegroupManage.addMember()">添加警员</button>
    </div> 
	<div class="span5">
		<button id="btndeleteMember" class="ty-btn-sccy ty-btn-offset2" style="margin-left:40px;"  onclick="PolicegroupManage.deleteMember()">删除警员</button> 
		<button id="btnclearUpMember" class="ty-btn-qkcy ty-btn-offset2"  onclick="PolicegroupManage.clearUpMember()">清空警员</button>
	</div>
